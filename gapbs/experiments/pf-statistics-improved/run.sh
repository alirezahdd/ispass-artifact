...
kernels=("tc" "bc" "bfs" "pr" "cc" "sssp") # ("tc" "bc" "bfs" "pr" "cc" "sssp") 
graphs=("twitter" "kron" "urand" "web" "road")   #("twitter" "kron" "urand" "web" "road")

available_memory=("30") # ("100" "90" "80" "70" "60" "50" "40" "30")
ocfs=("1") # Thread Oversubscription Factor. Default is "1". ("1" "2" "4" "8" "16" "32" "64" "128")
...
kernel_args["bc"]="-i3 -n1"					  # "-i3 -n5"       		# Default "-i4 -n16"
kernel_args["bfs"]="-n5"          		# Default "-n64"
kernel_args["cc"]="-n5"           		# Pact "-n5" Default "-n16"
kernel_args["pr"]="-i1000 -t1e-4 -n5" # Default "-i1000 -t1e-4 -n16"
kernel_args["sssp"]="-n5 -d2"     		# Default "-n64 -d2", ispass "-n5 -d2"
kernel_args["tc"]="-n1"      					# Default "-n3"
kernel_args["tc_road"]="-n1" 					# Default "-n3"
